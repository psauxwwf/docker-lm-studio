pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'LMSTUDIO_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-lm-studio'
    CONTAINER_NAME = 'lm-studio'
    DOCKERHUB_IMAGE = 'linuxserver/lm-studio'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/lm-studio'
    PR_DOCKERHUB_IMAGE = 'lspipepr/lm-studio'
    DIST_IMAGE = 'arch'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-lm-studio/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-lm-studio\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-lm-studio\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Lm-studio\" \
          --label \"org.opencontainers.image.description=[LM Studio](https://lmstudio.ai/) can run local AI models like gpt-oss, Llama, Gemma, Qwen, and DeepSeek privately on your computer.\" \
